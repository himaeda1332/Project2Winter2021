...
class Test_Part3(unittest.TestCase):
    ...
    def test_3_3_contents(self):
        ...
        self.assertEqual(self.wy_list[0].zipcode, "82431") # modified according to the slack, 82435
        self.assertEqual(self.wy_list[0].phone, "(307) 548-5406")
        self.assertEqual(self.wy_list[0].info(),"Bighorn Canyon (National Recreation Area): Lovell, WY 82431") # modified according to the slack, 82435
